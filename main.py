...
def main():
    ...
    try:
        ...
        if not podcast:
            print("No podcasts defined in list. Exiting.")
            sys.exit(0)
        ...
        if not video_id:
            print("No new episodes found or error occurred. Exiting.")
            sys.exit(0)
        ...
        if "Bot Detection" in str(e):
            print("ACTION REQUIRED: Please provide a valid cookies.txt for Tier 2 bypass.")
        sys.exit(1)
